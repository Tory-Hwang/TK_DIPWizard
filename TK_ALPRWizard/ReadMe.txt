================================================================================
    MFC 라이브러리 : TK_ALPRWizard 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 TK_ALPRWizard 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 TK_ALPRWizard 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

TK_ALPRWizard.vcproj
...
TK_ALPRWizard.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CTK_ALPRWizardApp 응용 프로그램
    클래스를 선언합니다.

TK_ALPRWizard.cpp
    응용 프로그램 클래스 CTK_ALPRWizardApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\TK_ALPRWizard.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 TK_ALPRWizard.rc에 의해 포함됩니다.

res\TK_ALPRWizard.rc2
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    TK_ALPRWizard.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
TK_ALPRWizardDoc.h, TK_ALPRWizardDoc.cpp ? 문서
    이 파일에는 CTK_ALPRWizardDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CTK_ALPRWizardDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

TK_ALPRWizardView.h, TK_ALPRWizardView.cpp ? 문서 뷰
    이 파일에는 CTK_ALPRWizardView 클래스가 들어 있습니다.
    CTK_ALPRWizardView 개체는 CTK_ALPRWizardDoc 개체를 보는 데 사용됩니다.

res\TK_ALPRWizardDoc.ico
    CTK_ALPRWizardDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 TK_ALPRWizard.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 TK_ALPRWizard.pch와
